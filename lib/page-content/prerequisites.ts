export type PrerequisitePillar = {
  number: string;
  title: string;
  blurb: string;
  why: string;
...
export const prerequisitePillars: PrerequisitePillar[] = [
  {
    number: "1",
  ...
  },
  {
    ...
    why: "To ensure the recommended fix actually works in your specific environment.",
    requirement:
  ...
  },
  {
    ...
    blurb:
      "I provide the objective reality of your operations. This may involve shining a light on some uncomfortable truths.",
    why:
      "If the findings are sugar-coated to the point of diluting the message, the ROI of the engagement drops dramatically.",
    requirement:
      "An agreement that we prioritize business objectives over organizational politics. I provide the \"ugly truth,\" and we focus entirely on the solution. Having said that, I can still be respectful and professional, and know how to deliver bad news in a palatable way.",
  },
];
